...
const Footer = () => {
  ...
  return (
    <footer className="py-12 px-6 sm:px-8 lg:px-12 bg-foreground text-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <h3 className="text-xl font-bold mb-4 font-serif">Zestful Kitchen</h3>
            <p className="text-white/70 mb-4">
              Delicious recipes made simple, with ingredients you already have.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Recipe Finder</a></li>
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Weekly Meal Plans</a></li>
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Shopping Lists</a></li>
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Nutrition Tracking</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/20 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-white/70 text-sm mb-4 sm:mb-0">
            © {currentYear} Zestful Kitchen. All rights reserved.
          </p>
